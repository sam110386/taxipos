        ...
        <div className="bnr_bg">
          <div className="banner_text row">
            <div className="col-md-6">
              <h1 className="white_text head_h1">
                No Commitment{" "}
                <strong>
                  {" "}
                  Pay As You <br /> Go Car Buying{" "}
                </strong>
              </h1>
              ...
              <Link to={userLoggedIn ? "/account/prequalify" : "/login"}>
                <button
                  type="button"
                  className="btn_bnner bg_color btn  mb-1 mr-2"
                >
                  Get Pre Qualified
                </button>
              </Link>
              <Link to="/cars">
                <button type="button" className=" btn_bnner btn mb-1">
                  {" "}
