...
const CallerIdDetails = (props) => {
  ...
  return (
    <React.Fragment>
      <div
        className="modal d-block callidmodal tripModal"
        tabIndex="-1"
        role="dialog"
      >
            ...
            <div className="align-items-center justify-content-center position-relative">
              <div className="modal-header">
                ...
                <h6 className="modal-title">
                  No Previous Trip Details Found :
                </h6>
                <img
                  ...
                  >
                    {({ errors, touched }) => (
                      <Form>
                        <>
                          <div
                            className="row  d-flex justify-content-left pl-0 pr-0 text-center"
                            id="myslider"
                          >
                            ...
                            <div className="col-md-5">
                              <div className="form-group ">Pick Up Address</div>
                            </div>
                            <div className="col-md-5">
                              <div className="form-group ">
                                Drop Off Address
                            ...
                            {props.details.all_trips &&
                              props.details.all_trips.map((e, index) => (
                                <>
                                  ...
                                  <div className="col-md-5">
                                    <div
                                      className="callerIdSlider"
                                      id="l01"
                                      tabindex="1"
                                      onClick={() =>
                                        setPickupDetails(
                                          e.Triplog.pickup_address,
                                          e.Triplog.pickup_lat,
                                          e.Triplog.pickup_lng
                                        )
                                      }
                                    >
                                  ...
                                  <div className="col-md-5">
                                    <div
                                      ...
                                      onClick={() =>
                                        setDropOffDetails(
                                          e.Triplog.dropoff_address,
                                          e.Triplog.dropoff_lat,
                                          e.Triplog.dropoff_lng
                                        )
                                      }
                                    >
